	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			try{
	        	...
	        	final String expectedMsg = "Account Created Successfully. Your temporary password has been sent to your email address.Are you sure?";
				if(expectedMsg.equals(session.getAttribute("message")))
				{
					Thread t = new Thread(new Runnable(){
				        public void run(){
				        	...
				        	JOptionPane.showMessageDialog(dialog, expectedMsg);
				        }
				    });
					t.start();
