...
public class GetAdvisorById extends SQLCmd{
	...
	public void queryDB(){
		try{
			String command = "SELECT pName,notification,name_low,name_high,degree_types,cutOffTime FROM User_Advisor WHERE userId=?";
	...
	public void processResult(){
		try{
			...
			i++;
			advisorUser.setCutOffPreference(res.getString(i));
			i++;
